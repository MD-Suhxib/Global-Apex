...
export default function Gallery02() {
  ...
  const marbleImages: GalleryImage[] = [
    { id: 1, name: "Black Granite Raw Block", type: "Granite", image: "/black Quarry.jpg" },
    { id: 2, name: "Leather Finish", type: "Granite", image: "/leatherf.jpg" },
    { id: 3, name: "Lapotra Finish", type: "Granite", image: "/lapotra2.png" },
    { id: 4, name: "Grey Honed", type: "Granite", image: "/grey honed.png" },
    { id: 5, name: "Honed Finish", type: "Granite", image: "/honed.png" },
    { id: 6, name: "Absolute Black Flamed", type: "Granite", image: "/Absoluteb-flamed.png" },
    { id: 7, name: "Flaming Finish", type: "Granite", image: "/flaming.png" },
    { id: 8, name: "50 mm Garden Blocks", type: "Granite", image: "/50mmG.png" },
    { id: 9, name: "Cobbal Stone Garden area", type: "Granite", image: "/Cobbal-garden.jpg" },
    { id: 10, name: "Cobbal Stone Driveway area", type: "Granite", image: "/Cobbal-new.jpg" },
    

    // Add more marble images as needed
  ]
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4 text-foreground tracking-tight">
                GRANITE <span className="text-[#c5a47e]">ROUGH</span> BLOCKS COLLECTION
              </h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Exquisite granite rough blocks for premium projects
              </p>

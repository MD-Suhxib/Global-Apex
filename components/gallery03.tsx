...
export default function Gallery03() {
  ...
  const images: GalleryImage[] = [
    // Add your marble images or other stone images here
    { id: 1, name: "Calacatta Marble", type: "Marble", image: "/Calacatta-marble.jpg" },
    { id: 2, name: "Black Marble", type: "Marble", image: "/Black-marble.jpg" },
